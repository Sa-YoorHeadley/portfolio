...
import { HeaderProps } from "./Component.types.js";

export default function Header({ theme, themeToggle }: HeaderProps) {
  ...
  return (
    <header
      id="header"
      className="transition-all z-[999] fixed top-0 left-0 w-full p-6 text-darkGray bg-white dark:bg-darkGray dark:text-white"
    >
      {/* Navigation */}
      <nav className="hidden lg:flex justify-around items-center">
        {/* Title */}
        <a className="text-3xl font-bold text-center" href="#home">
          Sa-Yoor Headley
        </a>
        ...
        <div className="flex gap-x-4 font-medium text-lg items-center h-8">
          <a
            className="transition-all hover:underline focus:underline"
            href="#home"
          >
            Home
          </a>
        ...
        <div className="flex gap-x-4">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="group flex flex-col items-center relative transition-all hover:bg-fill-white"
          >
            <svg
              className="transition-all w-6 h-6 fill-lightBlue group-hover:fill-black dark:group-hover:fill-white"
              viewBox="0 0 33 33"
              fill="none"
            ...
            >
              <g clipPath="url(#clip0_210_5)">
                <path
                  ...
                  d="M16.5297 0.123703C7.43512 0.123703 0.0602722 7.62286 0.0602722 16.8743C0.0602722 24.2753 4.77927 30.5543 11.3231 32.7692C12.1462 32.9243 12.4484 32.4059 12.4484 31.9634C12.4484 31.5639 12.4331 30.2444 12.426 28.8447C7.84418 29.8581 6.87735 26.8683 6.87735 26.8683C6.12818 24.9322 5.04873 24.4173 5.04873 24.4173C3.55445 23.3777 5.16137 23.3991 5.16137 23.3991C6.81518 23.517 7.68599 25.1252 7.68599 25.1252C9.1549 27.6861 11.5388 26.9457 12.4786 26.5177C12.6264 25.4354 13.0533 24.6958 13.5242 24.2778C9.86619 23.8543 6.02073 22.4179 6.02073 15.9994C6.02073 14.1706 6.66409 12.6763 7.71762 11.5032C7.54663 11.0811 6.98288 9.37764 7.87718 7.07032C7.87718 7.07032 9.26016 6.62013 12.4075 8.78735C13.7212 8.41624 15.1301 8.23006 16.5297 8.22374C17.9294 8.23006 19.3394 8.41624 20.6555 8.78735C23.799 6.62013 25.1801 7.07032 25.1801 7.07032C26.0765 9.37764 25.5125 11.0811 25.3415 11.5032C26.3975 12.6763 27.0366 14.1706 27.0366 15.9994C27.0366 22.4332 23.1838 23.8498 19.5164 24.2645C20.1071 24.7843 20.6335 25.8037 20.6335 27.3666C20.6335 29.6075 20.6144 31.4114 20.6144 31.9634C20.6144 32.4092 20.9108 32.9315 21.7456 32.767C28.2859 30.5495 32.9989 24.2728 32.9989 16.8743C32.9989 7.62286 25.6252 0.123703 16.5297 0.123703Z"
                />
                <path
                  className="fill-inherit"
                  d="M6.29807 24.1741C6.2618 24.2576 6.13307 24.2823 6.0158 24.2252C5.89634 24.1705 5.82925 24.0571 5.86798 23.9735C5.90343 23.8879 6.03243 23.8643 6.15161 23.9211C6.27134 23.9761 6.33953 24.0906 6.29807 24.1741Z"
                />
                <path
                  className="fill-inherit"
                  d="M6.96505 24.9308C6.88654 25.0049 6.73299 24.9705 6.62881 24.8534C6.52108 24.7367 6.5009 24.5805 6.58054 24.5053C6.66154 24.4312 6.81044 24.4659 6.91844 24.5827C7.02617 24.7008 7.0472 24.8559 6.96505 24.9308Z"
                />
                <path
                  className="fill-inherit"
                  d="M7.61454 25.8955C7.51368 25.9668 7.34868 25.8999 7.24665 25.751C7.14573 25.602 7.14573 25.4234 7.24886 25.3518C7.35109 25.2803 7.51368 25.3446 7.61701 25.4924C7.71766 25.6436 7.71766 25.8226 7.61454 25.8955Z"
                />
                <path
                  className="fill-inherit"
                  d="M8.50426 26.8275C8.41399 26.9288 8.22169 26.9017 8.08096 26.7635C7.93693 26.6284 7.89685 26.4367 7.98739 26.3355C8.07876 26.234 8.27216 26.2626 8.41399 26.3996C8.55685 26.5344 8.60051 26.7274 8.50426 26.8275Z"
                />
                <path
                  className="fill-inherit"
                  d="M9.73148 27.3688C9.69167 27.5 9.50646 27.5596 9.31994 27.5038C9.13363 27.4464 9.01173 27.2928 9.04941 27.1602C9.08812 27.0282 9.27408 26.966 9.46205 27.0256C9.64801 27.0828 9.77018 27.2354 9.73148 27.3688Z"
                />
                <path
                  className="fill-inherit"
                  d="M11.0793 27.4691C11.0839 27.6073 10.9257 27.7219 10.7299 27.7241C10.533 27.7287 10.3738 27.6169 10.3716 27.481C10.3716 27.3415 10.5262 27.2281 10.7231 27.2247C10.9189 27.2209 11.0793 27.3318 11.0793 27.4691Z"
                />
                <path
                  className="fill-inherit"
                  d="M12.3335 27.2519C12.3569 27.3868 12.2208 27.5252 12.0264 27.5618C11.8352 27.5976 11.6582 27.5144 11.634 27.3806C11.6102 27.2425 11.7488 27.1041 11.9397 27.0683C12.1344 27.0339 12.3087 27.1149 12.3335 27.2519Z"
                />
              </g>
            </svg>
            <p className="hidden text-center absolute -bottom-5 text-xs transition-all group-hover:block">
              Github
            </p>
          </a>
        ...
        <button onClick={themeToggle}>
          {theme === "dark" ? (
            <Icon
              className={`rotate-360 scale-1 transition-all w-8 h-8`}
              icon="ic:baseline-dark-mode"
            />
          ) : (
            <Icon
              className={`rotate-180 scale-1 transition-all w-8 h-8`}
      ...
      <nav className="relative flex flex-col lg:hidden">
        <div className="flex justify-around gap-x-2 items-center">
          ...
          {/* Title */}
          <a className="text-2xl sm:text-3xl font-bold text-center" href="home">
            Sa-Yoor Headley
          </a>
        ...
        <div
          ...
          } transition-all border-b border-x border-superDarkGray dark:border-lightGray border-3 absolute top-full left-1/2 translate-y-6 -translate-x-1/2 bg-white dark:bg-superDarkGray p-6 gap-3 flex flex-col items-center rounded-b-lg`}
        >
          {/* Page Links */}
          ...
          <div className="flex gap-x-4">
            ...
            >
              <svg
                className="transition-all w-6 h-6 fill-lightBlue group-hover:fill-white"
                viewBox="0 0 33 33"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
              >
