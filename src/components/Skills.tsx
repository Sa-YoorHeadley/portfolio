...
export default function Skills() {
  return (
    <section
      id="skills"
      className="transition-all bg-skills-light dark:bg-skills-dark bg-cover bg-veryLightGray text-veryDarkGray dark:bg-veryDarkGray dark:text-white pt-28 pb-16 flex flex-col items-center"
    >
      {/* Section Title */}
      ...
      <div className="flex flex-col items-center mt-6 md:flex-row md:justify-start md:space-x-16 md:items-start">
        ...
        <article className="flex flex-col items-center justify-baseline mt-6 w-72 text-center">
          {/* Title */}
          <h2 className="text-lg font-semibold h-16 text-superDarkGray dark:text-veryLightGray">
            Programming Languages / Frameworks / Libraries
          </h2>
          {/* Frontend */}
        ...
        <article className="flex flex-col items-center mt-6 w-72 text-center">
          {/* Title */}
          <h2 className="text-lg font-semibold md:h-16 text-superDarkGray dark:text-veryLightGray">
            Tools and Other Skills
          </h2>

          {/* Development / Design */}
          <h3 className="font-medium text-sm underline mt-4">
          ...
          {/* Programming Skills */}
          <h3 className="font-medium text-sm underline mt-3">
            Programming Skills
          </h3>
          {/* Tiles */}
          <div className="grid grid-cols-3 gap-y-6 gap-x-2 my-4">
      ...
      {/* CTA */}
      <a
        className="transition-all mt-20 text-lightBlue py-1 px-4 font-bold rounded-full bg-white hover:text-white hover:bg-lightBlue"
